          ...
          child:
            ...
            Container(
              ...
              child: Wrap(
                children: [
                  ThemeWidget(
                    imagePath: 'assets/icons/light_theme.png',
                    isSelected: true,
                  ),
                  ThemeWidget(
            ...
            ListTile(
                ...
                title: Text('Goal'),
                subtitle: Text('Keep track of your cycle',
            ...
            ListTile(
              ...
              subtitle: Text('2000', style: TextStyle(color: Colors.black54)),
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            Consumer<StoryProvider>(
              builder: (context, pro3, _) {
                return ListTile(
                  onTap: (){
                    StoryProvider pro = Provider.of<StoryProvider>(context);
                    ///////update receiveing
